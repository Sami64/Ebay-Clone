	...
	return (
		<div className="max-w-6xl mx-auto p-2">
			...
			<section className="flex py-3 space-x-6 text-xs md:text-sm whitespace-nowrap justify-center px-6">
				...
				<p className="link hidden sm:inline">Movies & TV</p>
				<p className="link hidden sm:inline">Books</p>
				<p className="link hidden sm:inline">Clothing</p>
				<p className="link hidden sm:inline">Home & Garden</p>
				<p className="link hidden sm:inline">Sports & Outdoors</p>
				<p className="link hidden sm:inline">Toys</p>
				<p className="link hidden sm:inline">Baby</p>
